"""
Django settings for dmj_radio_network_42323 project.
...
ROOT_URLCONF = 'dmj_radio_network_42323.urls'
...
WSGI_APPLICATION = 'dmj_radio_network_42323.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dmj_radio_network_42323 API",
    "DESCRIPTION": "API documentation for dmj_radio_network_42323 App",
    "VERSION": "v1",
}
